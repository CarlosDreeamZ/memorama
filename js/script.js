const MAXIMOS_INTENTOS = 20, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "./img/dorso.jpg"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
    ...
    methods: {
        ...
        indicarFracaso() {
            Swal.fire({
                    title: "Perdiste",
                    html: `
                <img class="img-fluid" src="./img/perdisteunu.jpg" alt="Perdiste">
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="./img/ganamos.jpg" alt="Ganaste">
